...
$t('message.layout.twoColumnsTitle')
				...
				<div class="layout-breadcrumb-seting-bar-flex mt11">
					...
					<div class="layout-breadcrumb-seting-bar-flex-value">
						<el-input-number v-model="getThemeConfig.lockScreenTime"
				...
				<div class="layout-breadcrumb-seting-bar-flex mt15" :style="{ opacity: isMobile ? 0.5 : 1 }">
					...
					<div class="layout-breadcrumb-seting-bar-flex-value">
						<el-switch v-model="getThemeConfig.isSortableTagsView"
...
export default defineComponent({
	...
	setup() {
		...
		//Set the layout switching function
		...
		//When closing the pop-up window, initialize the variables. Variables used to handle proxy.$refs.layoutScrollbarRef.update()
		const onDrawerClose = () => {
		...
		//Storage layout configuration global theme style (html root tag)
		...
		onMounted(() => {
			nextTick(() => {
				...
				// Listen for window size changes, non-default layout, set to default layout (adapted to mobile terminals)
