...
export default {
	...
	layout: {
		...
		dashboardmnt: 'dashboard',
		dashboard: 'dashboard',
		tenantmnt: 'Tenant Management',
		customermnt: 'customer management',
		usermnt: 'User management',
		producemnt: 'Product Management',
		devicemnt: 'Device Management',
		devicelist: 'Device Management',
		devicegraph: 'Gateway Configurator',
		assetsmnt: 'Asset Management',
		assetlist: 'Asset list',
		alarmmnt: 'alarm management',
		alarmlist: 'alarm list',
		rulesmnt: 'rule chain',
		flowlist: 'Designer',
		flowevents: 'events',
		settingsmnt: 'settings',
		dicgroupmnt: 'Dictionary group',
		dicmnt: 'dictionary',
		i18nlist: 'Internationalization',
		certmnt: 'Certificate Management',
	}
};
