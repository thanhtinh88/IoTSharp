<template>
    <div class="workflow-drawer-node">
        <el-tabs type="border-card" v-model="state.tabsActive">
            <!-- Extended form -->
            <el-tab-pane label="script" name="1">
                <el-scrollbar>
                ...
                <el-scrollbar>
                    <el-form :model="state.node" :rules="state.nodeRules" ref="nodeFormRef" size="default" label-width="80px"
                        ...
                        <!-- <el-form-item label="data id" prop="id">
                          <el-input v-model="state.node.id" placeholder="Please enter the data id" clearable disabled></el-input>
                        </el-form-item>
                        <el-form-item label="node id" prop="nodeId">
                          <el-input v-model="state.node.nodeId" placeholder="Please enter the node id" clearable disabled></el-input>
                        </el-form-item>
                        <el-form-item label="type" prop="type">
                          <el-input v-model="state.node.type" placeholder="Please enter the type" clearable disabled></el-input>
                        </el-form-item>
                        <el-form-item label="left coordinate" prop="left">
                          <el-input v-model="state.node.left" placeholder="Please enter the left coordinate" clearable disabled></el-input>
                        </el-form-item>
                        <el-form-item label="top coordinates" prop="top">
                          <el-input v-model="state.node.top" placeholder="Please enter top coordinates" clearable disabled></el-input>
                        </el-form-item>
                        <el-form-item label="icon icon" prop="icon">
                          <el-input v-model="state.node.icon" placeholder="Please enter the icon" clearable></el-input>
                        </el-form-item> -->
                        <el-form-item label="name" prop="name">
                            <el-input v-model="state.node.name" placeholder="Please enter a name" clearable></el-input>
                        </el-form-item>
                        <!-- <el-form-item>
