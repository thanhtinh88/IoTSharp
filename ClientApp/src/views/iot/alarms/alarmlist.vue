        ...
        <el-form size="default" label-width="100px" class="mt-10px">
            <el-row :gutter="35">
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <el-form-item label="Warning creation time">
                        <el-date-picker v-model="query.AckDateTime" type="daterange" start-placeholder="Start time"
                                        end-placeholder="end time" />
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <el-form-item label="Clear time">
                        <el-date-picker v-model="query.ClearDateTime" type="daterange" start-placeholder="Start time"
                                        end-placeholder="end time" />
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <el-form-item label="Duration start time">
                        <el-date-picker v-model="query.StartDateTime" type="daterange" start-placeholder="Start time"
                                        end-placeholder="end time" />
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-row :gutter="35">
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <el-form-item label="Warning end time">
                        <el-date-picker v-model="query.EndDateTime" type="daterange" start-placeholder="Start time"
                                        end-placeholder="end time" />
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <el-form-item label="Alarm type">
                        <el-input v-model="query.AlarmType" placeholder="Please enter the alarm type" />
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <el-form-item label="Alarm status">
                        <el-select v-model="query.alarmStatus" placeholder="Please select the alarm status">
            ...
            <el-row :gutter="35">
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <el-form-item label="Alarm level">
                        <el-select v-model="query.serverity" placeholder="Please select the alarm level">
                            <el-option v-for="item in serverityOptions" :key="item.value" :label="item.label" :value="item.value" />
                        </el-select>
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <el-form-item label="CauseSource">
                        <el-select v-model="query.originatorType" placeholder="Please select the origin">
                ...
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <el-form-item label="Cause object">
                        <el-select v-model="query.OriginatorId" placeholder="Please select the origin object" filterable remote reserve-keyword
        ...
        <el-table :data="tableData.rows" style="width: 100%" row-key="id" v-loading="loading">
            ...
            <el-table-column type="expand">
                <template #default="props">
                    <el-descriptions title="Cause object">
                        <el-descriptions-item label="Id">{{ props.row.originator.id }}</el-descriptions-item>
                        <el-descriptions-item label="name">{{ props.row.originator.name }}</el-descriptions-item>
                    </el-descriptions>
                </template>
            </el-table-column>
            <el-table-column prop="alarmType" label="Alarm Type" show-overflow-tooltip></el-table-column>
            <el-table-column prop="ackDateTime" label="Creation time" show-overflow-tooltip></el-table-column>
            <el-table-column prop="startDateTime" label="Start time for warning duration" show-overflow-tooltip></el-table-column>
            <el-table-column prop="endDateTime" label="Warning duration end time" show-overflow-tooltip></el-table-column>
            <el-table-column prop="Clear time" label="Warning duration end time" show-overflow-tooltip></el-table-column>
            <el-table-column prop="alarmStatus" label="Alarm Status" show-overflow-tooltip>
            ...
            <el-table-column prop="serverity" label="Severity" show-overflow-tooltip>
                <template #default="scope">
            ...
            <el-table-column prop="originatorType" label="Device Type" show-overflow-tooltip>
                <template #default="scope">
                    <el-tag size="small"
            ...
            <el-table-column label="Operation" show-overflow-tooltip width="200">
                <template #default="scope">
